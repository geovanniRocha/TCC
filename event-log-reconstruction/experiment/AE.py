...
def train(epoch, model, optimizer):
    ...
    #missing_matrix_w_normalized_time_trainLoader must be tensor, number, dict or list, now is object
    zips = zip(missing_matrix_w_normalized_time_trainLoader, complete_matrix_w_normalized_time_trainLoader,
               avai_matrix_trainLoader)
    enums = enumerate(zips)
    for batch_idx, a in enums:
        print('asd')
        (m_data, c_data, avai_mask) = a
