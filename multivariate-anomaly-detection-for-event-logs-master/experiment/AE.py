...
sys.path.insert(0, '/mnt/1912933D4BB17E55/TCC/tcc/multivariate-anomaly-detection-for-event-logs-master/utils/')
from utils import *
from models import *
...
parser = {
    ...
    'input_dir': '/mnt/1912933D4BB17E55/TCC/tcc/multivariate-anomaly-detection-for-event-logs-master/input/{}/'.format(name), 
    'batch_size' : 16,
    'epochs' : 100,
    'no_cuda' : True,
    'seed' : 7,
...
#train
input_trainLoader = torch.utils.data.DataLoader(input_, batch_size=args.batch_size, shuffle=False, num_workers=2)
